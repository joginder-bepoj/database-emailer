    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route
                    path="/database-emailer/checkbuisness"
                    element={<CheckBusiness />}
                />
                <Route
                    path="/database-emailer/checklinkedin"
                    element={<CheckLinkedIn />}
                />
                <Route path="/database-emailer/baddata" element={<BadData />} />
                <Route
                    path="/database-emailer/cellphonedata"
                    element={<CellPhoneData />}
                />
                <Route path="/database-emailer/newmovers" element={<NewMovers />} />
                <Route path="/database-emailer/urldata" element={<URLdata />} />
                <Route
                    path="/database-emailer/telemarketing"
                    element={<TelemarketingConsumer />}
                />
                <Route path="/database-emailer/mailmerge" element={<MailMerge />} />
                <Route
                    path="/database-emailer/sictonaciscodes"
                    element={<SICtoNAICScodes />}
                />
            </Routes>
        </>
    );
