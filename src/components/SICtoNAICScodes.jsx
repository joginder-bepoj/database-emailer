...
const SICtoNAICScodes = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const resNAICS = await axios.get(url + "/tblNAICS");
                const resRelation = await axios.get(url + "/tblSICStoNAICS");
                const resSIC = await axios.get(url + "/tblSicFT");
                setNAICS(resNAICS.data);
                setRelation(resRelation.data);
                setSIC(resSIC.data);
            } catch (err) {
                setError(err);
            }
                    ...
                    <table width="100%" id="NAICS_SIC">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>8721</td>
                                <td>
                                    Accounting, Auditing, and Bookkeeping Services (other
                                    accounting services)
                                </td>
                                <td>541219</td>
                            ...
                            <tr>
                                <td>9441</td>
                                <td>
                                    Administration of Social, Human Resource and Income
                            ...
                            <tr>
                                <td>9451</td>
                                <td>
                                    Administration of Veterans' Affairs, Except Health and
                                    Insurance
                                </td>
                                <td>923140</td>
                            ...
                            <tr>
                                <td>7319</td>
                                <td>
                                    Advertising, NEC (display advertising, aerial advertising
                                    using special purpose aircraft, such as blimps)
                                </td>
                                <td>541850</td>
                            ...
                            <tr>
                                <td>4522</td>
                                <td>
                                    Air Transportation, Nonscheduled (using general purpose
                                    aircraft for a variety of passenger, freight, courier, and
                                    other uses)
                                </td>
                                <td>481219</td>
                                <td>Other Nonscheduled Air Transportation</td>
                            ...
                            <tr>
                                <td>3728</td>
                                <td>
                                    Aircraft Parts and Auxiliary Equipment, NEC (except fluid
                                    power aircraft subassemblies, target drones, and research and
                                    development not producing prototypes)
                                </td>
                                <td>336413</td>
                                <td>
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (aerial tramways,
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (bridge instruction,
                                    yoga instruction, and similar nonathletic instruction)
                                </td>
                                <td>611699</td>
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (charter fishing)
                                </td>
                                <td>487210</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    commercial parks, skiing facilities, casinos and other
                                    gambling operations, nonmembership fitness and recreational
                                    sports centers, sports instruction, sports equipment rental,
                                    ticket agencies, charter fishing, state fairs, agriculture
                                    fairs, county fairs, operation of fishing lakes, phrenologists
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (lottery, bingo,
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (phrenologists
                                    services)
                                </td>
                                <td>812990</td>
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (state fairs,
                            ...
                            <tr>
                                <td>7999</td>
                                <td>
                                    Amusement and Recreation Services, NEC (ticket agencies)
                                </td>
                                <td>561599</td>
                            ...
                            <tr>
                                <td>0752</td>
                                <td>
                                    Animal Specialty Services, Except Veterinary (pet care
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    handkerchiefs, arm bands, cummerbunds, suspenders, etc.,
                                    except contractors)
                                </td>
                                <td>315999</td>
                                <td>
                            ...
                            <tr>
                                <td>2387</td>
                                <td>
                                    Apparel Belts (women's, girls', and infants' contractors)
                                </td>
                                <td>315212</td>
                                <td>
                                    Women's, Girls', and Infants' Cut and Sew Apparel Contractors
                            ...
                            <tr>
                                <td>4729</td>
                                <td>
                                    Arrangement of Passenger Transportation, NEC (except
                            ...
                            <tr>
                                <td>5531</td>
                                <td>
                                    Auto and Home Supply Stores (other auto and home supply
                                    stores)
                                </td>
                                <td>452990</td>
                            ...
                            <tr>
                                <td>7539</td>
                                <td>
                                    Automotive Repair Shops, NEC (except automotive
                            ...
                            <tr>
                                <td>7549</td>
                                <td>
                                    Automotive Services, Except Repair and Carwashes (towing)
                                </td>
                                <td>488410</td>
                            ...
                            <tr>
                                <td>7231</td>
                                <td>
                                    Beauty Shops (except beauty and cosmetology schools and
                            ...
                            <tr>
                                <td>5181</td>
                                <td>
                                    Beer and Ale (merchant wholesalers except those selling beer
                                    and ale via retail method)
                                </td>
                                <td>424810</td>
                            ...
                            <tr>
                                <td>5192</td>
                                <td>
                                    Books, Periodicals, and Newspapers (merchant wholesalers
                                    except those selling publications via retail method)
                                </td>
                                <td>424920</td>
                            ...
                            <tr>
                                <td>5032</td>
                                <td>
                                    Brick, Stone, and Related Construction Materials (brick,
                            ...
                            <tr>
                                <td>2231</td>
                                <td>
                                    Broadwoven Fabric Mills, Wool (wool broadwoven fabric
                            ...
                            <tr>
                                <td>8748</td>
                                <td>
                                    Business Consulting Services, NEC (educational test
                            ...
                            <tr>
                                <td>8748</td>
                                <td>
                                    Business Consulting Services, NEC (urban planners and
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services (appraisers except insurance and real
                                    estate, outplacement services, and miscellaneous professional,
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (apparel pressing service for the
                                    trade)
                                </td>
                                <td>812320</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    telephone answering, telemarketing bureaus, private mail
                                    centers and repossession services)
                                </td>
                                <td>561499</td>
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (convention and visitors bureaus,
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (distribution of telephone directories
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (embroidery of advertising on shirts
                                    and rug binding for the trade)
                                </td>
                                <td>314999</td>
                                <td>All Other Miscellaneous Textile Product Mills</td>
                            </tr>
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (other support services except
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (packaging and labeling services)
                                </td>
                                <td>561910</td>
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (press clipping services and stock
                                    photo agencies)
                                </td>
                                <td>519190</td>
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (private mail centers and mailbox
                                    rental)
                                </td>
                                <td>561431</td>
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (swimming pool cleaning and
                                    maintenance)
                                </td>
                                <td>561790</td>
                                <td>Other Services to Buildings and Dwellings</td>
                            ...
                            <tr>
                                <td>7389</td>
                                <td>
                                    Business Services, NEC (translation and interpretation
                                    services)
                                </td>
                                <td>541930</td>
                            ...
                            <tr>
                                <td>4841</td>
                                <td>
                                    Cable and Other Pay Television Services (except cable and
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Computers (point of sale terminals and fund transfer devices)
                                </td>
                                <td>334119</td>
                            ...
                            <tr>
                                <td>2064</td>
                                <td>
                                    Candy and Other Confectionery Products (chocolate
                                    confectionery)
                                </td>
                                <td>311330</td>
                            ...
                            <tr>
                                <td>5441</td>
                                <td>
                                    Candy, Nut, and Confectionery Stores (nonchocolate candy
                            ...
                            <tr>
                                <td>5169</td>
                                <td>
                                    Chemicals and Allied Products, NEC (merchant wholesalers)
                                </td>
                                <td>424690</td>
                            ...
                            <tr>
                                <td>2899</td>
                                <td>
                                    Chemicals and Chemical Preparations, NEC (frit and plastic
                                    wood fillers)
                                </td>
                                <td>325510</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    advocacy associations, temperance organizations, and Indian
                                    and Alaska Native Tribal Councils)
                                </td>
                                <td>813410</td>
                            ...
                            <tr>
                                <td>1241</td>
                                <td>
                                    Coal Mining Services (site preparation and related
                                    construction activities on a contract basis)
                                </td>
                                <td>238910</td>
                            ...
                            <tr>
                                <td>3479</td>
                                <td>
                                    Coating, Engraving, and Allied Services, NEC (silver and
                            ...
                            <tr>
                                <td>7993</td>
                                <td>
                                    Coin-Operated Amusement Devices (slot machine operators)
                                </td>
                                <td>713290</td>
                                <td>Other Gambling Industries</td>
                            </tr>
                            ...
                            <tr>
                                <td>4939</td>
                                <td>
                                    Combination Utilities, NEC (electric power distribution)
                                </td>
                                <td>221122</td>
                            ...
                            <tr>
                                <td>4939</td>
                                <td>
                                    Combination Utilities, NEC (fossil fuel power generation)
                                </td>
                                <td>221112</td>
                            ...
                            <tr>
                                <td>4899</td>
                                <td>
                                    Communications Services, NEC (except ship to shore
                            ...
                            <tr>
                                <td>4899</td>
                                <td>
                                    Communications Services, NEC (radio broadcasting operated by
                                    cab companies)
                                </td>
                                <td>485310</td>
                                <td>Taxi Service</td>
                            ...
                            <tr>
                                <td>3577</td>
                                <td>
                                    Computer Peripheral Equipment, NEC (magnetic tape head
                                    cleaners)
                                </td>
                                <td>334613</td>
                            ...
                            <tr>
                                <td>7379</td>
                                <td>
                                    Computer Related Services, NEC (disk conversion services)
                                </td>
                                <td>518210</td>
                                <td>Data Processing, Hosting, and Related Services</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    Computers and Computer Peripheral Equipment and Software
                                    (merchant wholesalers except those selling computers,
                                    equipment, and software via retail method)
                                </td>
                                <td>423430</td>
                                <td>
                            ...
                            <tr>
                                <td>3272</td>
                                <td>
                                    Concrete Products, Except Block and Brick (dry mixture
                                    concrete)
                                </td>
                                <td>327999</td>
                                <td>
                            ...
                            <tr>
                                <td>3531</td>
                                <td>
                                    Construction Machinery and Equipment (railway track
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    buildings and structural assemblies and merchant wholesalers
                            ...
                            <tr>
                                <td>2679</td>
                                <td>
                                    Converted Paper and Paperboard Products, NEC ( except
                            ...
                            <tr>
                                <td>2679</td>
                                <td>
                                    Converted Paper and Paperboard Products, NEC (corrugated
                                    paper)
                                </td>
                                <td>322211</td>
                            ...
                            <tr>
                                <td>2679</td>
                                <td>
                                    Converted Paper and Paperboard Products, NEC (paper supplies
                                    for business machines, such as adding machine tape, and other
                            ...
                            <tr>
                                <td>2679</td>
                                <td>
                                    Converted Paper and Paperboard Products, NEC (wallpaper and
                                    gift wrap paper)
                                </td>
                                <td>322222</td>
                                <td>Coated and Laminated Paper Manufacturing</td>
                            ...
                            <tr>
                                <td>2052</td>
                                <td>
                                    Cookies and Crackers (unleavened bread and soft pretzels)
                                </td>
                                <td>311812</td>
                                <td>Commercial Bakeries</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Precision Measuring Devices (except precision measuring
                                    devices)
                                </td>
                                <td>333515</td>
                            ...
                            <tr>
                                <td>5143</td>
                                <td>
                                    Dairy Products, Except Dried or Canned (dairy products sold
                                    via retail method)
                                </td>
                                <td>445299</td>
                                <td>All Other Specialty Food Stores</td>
                            ...
                            <tr>
                                <td>8243</td>
                                <td>
                                    Data Processing Schools (except computer repair training)
                                </td>
                                <td>611420</td>
                            ...
                            <tr>
                                <td>4481</td>
                                <td>
                                    Deep Sea Transportation of Passengers, Except by Ferry (deep
                                    sea activities)
                                </td>
                                <td>483112</td>
                            ...
                            <tr>
                                <td>7381</td>
                                <td>
                                    Detective, Guard, and Armored Car Services (detective
                                    services)
                                </td>
                                <td>561611</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    lined, laminated, or surface coated paperboard and die-cut
                            ...
                            <tr>
                                <td>7331</td>
                                <td>
                                    Direct Mail Advertising Services (except mailing list
                                    compilers)
                                </td>
                                <td>541860</td>
                            ...
                            <tr>
                                <td>7342</td>
                                <td>
                                    Disinfecting and Pest Control Services (except exterminating
                                    and pest control)
                                </td>
                                <td>561720</td>
                                <td>Janitorial Services</td>
                            ...
                            <tr>
                                <td>3357</td>
                                <td>
                                    Drawing and Insulating of Nonferrous Wire (copper wire
                                    drawing)
                                </td>
                                <td>331422</td>
                            ...
                            <tr>
                                <td>5122</td>
                                <td>
                                    Drugs, Drug Proprietaries, and Druggists' Sundries (business
                            ...
                            <tr>
                                <td>5099</td>
                                <td>
                                    Durable Goods, NEC (coin-operated game machines sold via
                                    retail method)
                                </td>
                                <td>451120</td>
                            ...
                            <tr>
                                <td>5099</td>
                                <td>
                                    Durable Goods, NEC (prerecorded audio and video tapes and
                                    discs sold via retail method)
                                </td>
                                <td>451220</td>
                            ...
                            <tr>
                                <td>4931</td>
                                <td>
                                    Electric and Other Services Combined (natural gas
                                    distribution)
                                </td>
                                <td>221210</td>
                                <td>Natural Gas Distribution</td>
                            ...
                            <tr>
                                <td>4931</td>
                                <td>
                                    Electric and Other Services Combined (nuclear power
                                    generation)
                                </td>
                                <td>221113</td>
                                <td>Nuclear Electric Power Generation</td>
                            ...
                            <tr>
                                <td>3634</td>
                                <td>
                                    Electric Housewares and Fans (except wall and baseboard
                                    heating units for permanent installation, electronic cigarette
                                    lighters, and wall mount restroom hand dryers)
                                </td>
                                <td>335211</td>
                            ...
                            <tr>
                                <td>7629</td>
                                <td>
                                    Electrical and Electronic Repair Shops, NEC (business and
                                    office machine repair, electrical){" "}
                                </td>
                                <td>811212</td>
                                <td>Computer and Office Machine Repair and Maintenance</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    appliance repair, washing machine repair, electric razor
                                    repair)
                                </td>
                                <td>811412</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Electrical and Electronic Repair Shops, NEC (electrical
                                    measuring instrument repair and calibration, medical
                            ...
                            <tr>
                                ...
                                <td>
                                    Electrical Apparatus and Equipment, Wiring Supplies and
                                    Construction Materials (business to business electronic
                                    markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    selling electrical supplies, equipment, and apparatus via
                                    retail method)
                                </td>
                                <td>423610</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    wholesalers except those selling appliances, TVs, and radios
                                    via retail method)
                                </td>
                                <td>423620</td>
                                <td>
                            ...
                            <tr>
                                <td>5064</td>
                                <td>
                                    Electrical Appliances, Television and Radio Sets (television
                                    and radio sets sold via retail method)
                                </td>
                                <td>443112</td>
                            ...
                            <tr>
                                <td>3699</td>
                                <td>
                                    Electrical Machinery Equipment, and Supplies, NEC (laser
                            ...
                            <tr>
                                <td>3679</td>
                                <td>
                                    Electronic Components, NEC (printed circuit/electronic
                            ...
                            <tr>
                                <td>5065</td>
                                <td>
                                    Electronic Parts and Equipment, NEC (agents and brokers)
                                </td>
                                <td>425120</td>
                                <td>Wholesale Trade Agents and Brokers</td>
                            </tr>
                            ...
                            <tr>
                                <td>5065</td>
                                <td>
                                    Electronic Parts and Equipment, NEC (merchant wholesalers
                                    except those selling electronic parts and equipment via retail
                                    method)
                                </td>
                                <td>423690</td>
                                <td>
                            ...
                            <tr>
                                <td>7359</td>
                                <td>
                                    Equipment Rental and Leasing, NEC (aircraft rental and
                                    leasing)
                                </td>
                                <td>532411</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    equipment; appliances; general rental centers; portable
                                    toilets; office machines; oil field and oil well drilling
                                    equipment; and home and garden equipment rental and leasing)
                                </td>
                                <td>532299</td>
                            ...
                            <tr>
                                <td>3443</td>
                                <td>
                                    Fabricated Plate Work (Boiler Shops) (fabricated plate work
                                    and metal weldments)
                                </td>
                                <td>332313</td>
                            ...
                            <tr>
                                <td>3069</td>
                                <td>
                                    Fabricated Rubber Products, NEC (rubberizing fabric or
                            ...
                            <tr>
                                <td>2399</td>
                                <td>
                                    Fabricated Textile Products, NEC (seat belts, and seat and
                                    tire covers)
                                </td>
                                <td>336360</td>
                                <td>Motor Vehicle Seating and Interior Trim Manufacturing</td>
                            ...
                            <tr>
                                <td>2399</td>
                                <td>
                                    Fabricated Textile Products, NEC (women's, girls', and
                                    infants' contractors)
                                </td>
                                <td>315212</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    gates, hand clippers for animals, and farm
                                    conveyors/elevators)
                                </td>
                                <td>333111</td>
                            ...
                            <tr>
                                <td>5191</td>
                                <td>
                                    Farm Supplies (lawn and garden supplies sold via retail
                                    method)
                                </td>
                                <td>444220</td>
                            ...
                            <tr>
                                <td>5159</td>
                                <td>
                                    Farm-Product Raw Materials, NEC (business to business
                                    electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>5159</td>
                                <td>
                                    Farm-Product Raw Materials, NEC (farm-product raw materials
                                    sold via retail method)
                                </td>
                                <td>444220</td>
                                <td>Nurseries, Garden Centers, and Farm Supply Stores</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    those selling farm product raw materials, nec via retail
                                    method)
                                </td>
                                <td>424590</td>
                            ...
                            <tr>
                                <td>0139</td>
                                <td>
                                    Field Crops, Except Cash Grains, NEC (broom corn farming)
                                </td>
                                <td>111199</td>
                                <td>All Other Grain Farming</td>
                            </tr>
                            ...
                            <tr>
                                <td>6331</td>
                                <td>
                                    Fire, Marine, and Casualty Insurance (fire, marine, and
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Motor Vehicle Transportation (except marine cargo checkers)
                                </td>
                                <td>488490</td>
                                <td>Other Support Activities for Road Transportation</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Fixed Facilities and Inspection and Weighing Services for
                                    Motor Vehicle Transportation (marine cargo checkers)
                                </td>
                                <td>488390</td>
                            ...
                            <tr>
                                <td>2087</td>
                                <td>
                                    Flavoring Extracts and Flavoring Syrups, NEC (flavoring
                                    extracts and natural food colorings)
                                </td>
                                <td>311942</td>
                                <td>Spice and Extract Manufacturing</td>
                            </tr>
                            <tr>
                                <td>2087</td>
                                <td>
                                    Flavoring Extracts and Flavoring Syrups, NEC (powered drink
                                    mix)
                                </td>
                                <td>311999</td>
                                <td>All Other Miscellaneous Food Manufacturing</td>
                            ...
                            <tr>
                                <td>5193</td>
                                <td>
                                    Flowers, Nursery Stock, and Florists' Supplies (sold via
                                    retail method)
                                </td>
                                <td>444220</td>
                                <td>Nurseries, Garden Centers, and Farm Supply Stores</td>
                            ...
                            <tr>
                                <td>2657</td>
                                <td>
                                    Folding Paperboard Boxes, Including Sanitary (except
                            ...
                            <tr>
                                <td>2099</td>
                                <td>
                                    Food Preparations, NEC (bouillon and potatoes dried and
                                    packaged with other ingredients produced in dehydrating
                                    plants)
                                </td>
                                <td>311423</td>
                                <td>Dried and Dehydrated Food Manufacturing</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    spices, peanut butter, perishable prepared foods, tortillas,
                                    tea and tea extracts, dry dip mix, prepared dips, dry salad
                                    dressing mix, seasoning mix, dried potatoes, pasta, and rice
                                    mixed with other ingredients in mills or dehydrating plants,
                                    reducing maple sap to maple syrup, wool grease, and vinegar)
                                </td>
                                <td>311999</td>
                                <td>All Other Miscellaneous Food Manufacturing</td>
                            </tr>
                            ...
                            <tr>
                                <td>2099</td>
                                <td>
                                    Food Preparations, NEC (spices, dry dip mix, dry salad
                            ...
                            <tr>
                                <td>5139</td>
                                <td>
                                    Footwear (merchant wholesalers except those selling footwear
                                    via retail method)
                                </td>
                                <td>424340</td>
                            ...
                            <tr>
                                <td>6099</td>
                                <td>
                                    Functions Related to Depository Banking, NEC (except
                                    electronic funds transfer networks and clearinghouses, foreign
                                    currency exchanges, escrow and fiduciary agencies and deposit
                                    brokers)
                                </td>
                                <td>522390</td>
                            ...
                            <tr>
                                <td>5021</td>
                                <td>
                                    Furniture (merchant wholesalers except those selling via
                                    retail method)
                                </td>
                                <td>423210</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Single-Family (dormitory, barrack, hotel, and motel
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    construction contractors, and dormitory and barrack
                                    construction contractors)
                                </td>
                                <td>236116</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    General Contractors Industrial Buildings and Warehouses (
                                    except grain elevators; drycleaning plants; and manufacturing,
                                    public, and industrial warehouses)
                                </td>
                                <td>236210</td>
                            ...
                            <tr>
                                <td>4225</td>
                                <td>
                                    General Warehousing and Storage (miniwarehouses and
                                    self-storage units)
                                </td>
                                <td>531130</td>
                            ...
                            <tr>
                                <td>2369</td>
                                <td>
                                    Girls', Children's, and Infants' Outerwear, NEC (boys' suits
                                    and coats except contractors)
                                </td>
                                <td>315222</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>315234</td>
                                <td>
                                    Women's and Girls' Cut and Sew Suit, Coat, Tailored Jacket,
                            ...
                            <tr>
                                <td>2369</td>
                                <td>
                                    Girls', Children's, and Infants' Outerwear, NEC (infants'
                                    except contractors)
                                </td>
                                <td>315291</td>
                                <td>Infants' Cut and Sew Apparel Manufacturing</td>
                            ...
                            <tr>
                                <td>5153</td>
                                <td>
                                    Grain and Field Beans (business to business electronic
                                    markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>5153</td>
                                <td>
                                    Grain and Field Beans (merchant wholesalers except those
                                    selling grains and field beans via retail method)
                                </td>
                                <td>424510</td>
                            ...
                            <tr>
                                <td>5149</td>
                                <td>
                                    Groceries and Related Products, NEC (agents and brokers)
                                </td>
                                <td>425120</td>
                                <td>Wholesale Trade Agents and Brokers</td>
                            </tr>
                            ...
                            <tr>
                                <td>5149</td>
                                <td>
                                    Groceries and Related Products, NEC (merchant wholesalers
                                    except processed bottled water manufacturing and merchant
                                    wholesalers selling groceries and related products via retail
                                    method)
                                </td>
                                <td>424490</td>
                            ...
                            <tr>
                                <td>5141</td>
                                <td>
                                    Groceries, General Line (general line groceries sold via
                                    retail method)
                                </td>
                                <td>445110</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Equipment, NEC (except research and development not producing
                                    prototypes)
                                </td>
                                <td>336419</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Guided Missile and Space Vehicle Propulsion Units and
                                    Propulsion Unit Parts (research and development not producing
                                    prototypes)
                                </td>
                                <td>541712</td>
                                <td>
                            ...
                            <tr>
                                <td>5072</td>
                                <td>
                                    Hardware (merchant wholesalers except those selling hardware
                                    via retail method)
                                </td>
                                <td>423710</td>
                            ...
                            <tr>
                                <td>3429</td>
                                <td>
                                    Hardware, NEC (except fire hose nozzles, hose couplings,
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    resawing hardwood lumber, and planing purchased hardwood
                                    lumber except flooring)
                                </td>
                                <td>321912</td>
                            ...
                            <tr>
                                <td>2426</td>
                                <td>
                                    Hardwood Dimension and Flooring Mills (hardwood dimension
                                    lumber made from logs or bolts)
                                </td>
                                <td>321113</td>
                                <td>Sawmills</td>
                            </tr>
                            ...
                            <tr>
                                <td>2426</td>
                                <td>
                                    Hardwood Dimension and Flooring Mills (wood furniture frames
                                    and finished furniture parts)
                                </td>
                                <td>337215</td>
                                <td>Showcase, Partition, Shelving, and Locker Manufacturing</td>
                            </tr>
                            ...
                            <tr>
                                <td>8099</td>
                                <td>
                                    Health and Allied Services, NEC (childbirth preparation)
                                </td>
                                <td>621410</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    medical artists, medical photography, and childbirth
                                    preparation classes)
                                </td>
                                <td>621999</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    plants [except hydroelectric dams] transmission and
                                    distribution stations, right-of-way clearing, line slashing,
                            ...
                            <tr>
                                <td>5023</td>
                                <td>
                                    Homefurnishings (business to business electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            </tr>
                            ...
                            <tr>
                                <td>2252</td>
                                <td>
                                    Hosiery, NEC (girls' full length and knee length sheer
                                    hosiery)
                                </td>
                                <td>315111</td>
                            ...
                            <tr>
                                <td>7011</td>
                                <td>
                                    Hotels and Motels (except hotels, motels, and bed and
                                    breakfast inns)
                                </td>
                                <td>721199</td>
                            ...
                            <tr>
                                <td>2392</td>
                                <td>
                                    Housefurnishings, Except Curtains and Draperies (floor and
                                    dust mops)
                                </td>
                                <td>339994</td>
                                <td>Broom, Brush, and Mop Manufacturing</td>
                            ...
                            <tr>
                                <td>2835</td>
                                <td>
                                    In Vitro and In Vivo Diagnostic Substances (in-vitro
                                    diagnostic substances)
                                </td>
                                <td>325413</td>
                            ...
                            <tr>
                                <td>8322</td>
                                <td>
                                    Individual and Family Social Services (child and youth
                                    services)
                                </td>
                                <td>624110</td>
                            ...
                            <tr>
                                <td>8322</td>
                                <td>
                                    Individual and Family Social Services (services for the
                            ...
                            <tr>
                                <td>2819</td>
                                <td>
                                    Industrial Inorganic Chemicals, NEC (except activated carbon
                                    and charcoal, alumina, recovering sulfur from natural gas, and
                                    inorganic dyes)
                                </td>
                                <td>325188</td>
                            ...
                            <tr>
                                <td>5085</td>
                                <td>
                                    Industrial Supplies (merchant wholesalers of industrial
                                    supplies except fluid power accessories and merchant
                                    wholesalers selling industrial supplies via retail method)
                                </td>
                                <td>423840</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    dust collection, and other industrial ventilation
                                    installation)
                                </td>
                                <td>238220</td>
                            ...
                            <tr>
                                <td>8052</td>
                                <td>
                                    Intermediate Care Facilities (except continuing care
                            ...
                            <tr>
                                <td>6799</td>
                                <td>
                                    Investors, NEC (venture capital companies, investment clubs,
                                    and speculators for own account)
                                </td>
                                <td>523910</td>
                            ...
                            <tr>
                                <td>3915</td>
                                <td>
                                    Jewelers Findings and Materials and Lapidary Work (watch
                                    jewels)
                                </td>
                                <td>334518</td>
                                <td>Watch, Clock, and Part Manufacturing</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Jewelry, Watches, Precious Stones, and Precious Metals
                                    (merchant wholesalers except those selling jewelry and related
                                    goods via retail method)
                                </td>
                                <td>423940</td>
                                <td>
                            ...
                            <tr>
                                <td>2254</td>
                                <td>
                                    Knit Underwear and Nightwear Mills (except dyeing and
                                    finishing underwear and nightwear without knitting garments)
                                </td>
                                <td>315192</td>
                                <td>Underwear and Nightwear Knitting Mills</td>
                            </tr>
                            ...
                            <tr>
                                <td>7219</td>
                                <td>
                                    Laundry and Garment Services, NEC (alteration and repair)
                                </td>
                                <td>811490</td>
                                <td>
                                    Other Personal and Household Goods Repair and Maintenance
                            ...
                            <tr>
                                <td>2386</td>
                                <td>
                                    Leather and Sheep-Lined Clothing (women's, girls', and
                                    infants' contractors)
                                </td>
                                <td>315212</td>
                                <td>
                            ...
                            <tr>
                                <td>3151</td>
                                <td>
                                    Leather Gloves and Mittens (men's and boys' contractors)
                                </td>
                                <td>315211</td>
                                <td>Men's and Boys' Cut and Sew Apparel Contractors</td>
                            </tr>
                            ...
                            <tr>
                                <td>4119</td>
                                <td>
                                    Local Passenger Transportation, NEC (sightseeing buses and
                                    cable and cog railways, except scenic)
                                </td>
                                <td>487110</td>
                                <td>Scenic and Sightseeing Transportation, Land</td>
                            </tr>
                            ...
                            <tr>
                                <td>5211</td>
                                <td>
                                    Lumber and Other Building Materials Dealers (except home
                                    center stores)
                                </td>
                                <td>444190</td>
                                <td>Other Building Material Dealers</td>
                            ...
                            <tr>
                                <td>5211</td>
                                <td>
                                    Lumber and Other Building Materials Dealers (home center
                                    stores)
                                </td>
                                <td>444110</td>
                                <td>Home Centers</td>
                            ...
                            <tr>
                                <td>5031</td>
                                <td>
                                    Lumber, Plywood, Millwork, and Wood Panels (agents and
                                    brokers)
                                </td>
                                <td>425120</td>
                                <td>Wholesale Trade Agents and Brokers</td>
                            ...
                            <tr>
                                <td>5031</td>
                                <td>
                                    Lumber, Plywood, Millwork, and Wood Panels (business to
                                    business electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>8741</td>
                                <td>
                                    Management Services (construction management for other heavy
                            ...
                            <tr>
                                <td>8741</td>
                                <td>
                                    Management Services (construction management of power
                                    generation [except hydroelectric] facilities, and transmission
                                    and distribution station construction projects)
                                </td>
                                <td>237130</td>
                                <td>
                                    Power and Communication Line and Related Structures
                            ...
                            <tr>
                                <td>3999</td>
                                <td>
                                    Manufacturing Industries, NEC (beauty and barber shop
                            ...
                            <tr>
                                <td>3999</td>
                                <td>
                                    Manufacturing Industries, NEC (lamp shades of paper or
                                    textile)
                                </td>
                                <td>335121</td>
                            ...
                            <tr>
                                <td>3999</td>
                                <td>
                                    Manufacturing Industries, NEC (other miscellaneous products
                                    not specially provided for previously)
                                </td>
                                <td>339999</td>
                                <td>All Other Miscellaneous Manufacturing</td>
                            </tr>
                            <tr>
                                <td>3999</td>
                                <td>
                                    Manufacturing Industries, NEC (plastics products such as
                            ...
                            <tr>
                                <td>2515</td>
                                <td>
                                    Mattresses, Foundations, and Convertible Beds (convertible
                                    beds)
                                </td>
                                <td>337121</td>
                                <td>Upholstered Household Furniture Manufacturing</td>
                            ...
                            <tr>
                                <td>3829</td>
                                <td>
                                    Measuring and Controlling Devices, NEC (electronic
                                    chronometers)
                                </td>
                                <td>334518</td>
                                <td>Watch, Clock, and Part Manufacturing</td>
                            ...
                            <tr>
                                <td>5147</td>
                                <td>
                                    Meats and Meat Products (merchant wholesalers except boxed
                                    beef manufacturers and merchant wholesalers selling meats and
                                    meat products via retail method)
                                </td>
                                <td>424470</td>
                            ...
                            <tr>
                                <td>7352</td>
                                <td>
                                    Medical Equipment Rental and Leasing (home health furniture
                            ...
                            <tr>
                                <td>5047</td>
                                <td>
                                    Medical, Dental and Hospital Equipment and Supplies (agents
                                    and brokers)
                                </td>
                                <td>425120</td>
                                <td>Wholesale Trade Agents and Brokers</td>
                            ...
                            <tr>
                                <td>5047</td>
                                <td>
                                    Medical, Dental and Hospital Equipment and Supplies (business
                                    to business electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    business organizations, athletic associations, and travel
                                    motor clubs)
                                </td>
                                <td>813410</td>
                                <td>Civic and Social Organizations</td>
                            ...
                            <tr>
                                <td>7997</td>
                                <td>
                                    Membership Sports and Recreation Clubs (recreation clubs
                                    without facilities)
                                </td>
                                <td>713990</td>
                                <td>All Other Amusement and Recreation Industries</td>
                            ...
                            <tr>
                                <td>2329</td>
                                <td>
                                    Men's and Boys' Clothing, NEC (except team athletic uniforms
                                    and contractors)
                                </td>
                                <td>315228</td>
                                <td>
                            ...
                            <tr>
                                <td>2321</td>
                                <td>
                                    Men's and Boys' Shirts, Except Work Shirts (contractors)
                                </td>
                                <td>315211</td>
                                <td>Men's and Boys' Cut and Sew Apparel Contractors</td>
                            </tr>
                            <tr>
                                <td>2321</td>
                                <td>
                                    Men's and Boys' Shirts, Except Work Shirts (except
                                    contractors)
                                </td>
                                <td>315223</td>
                                <td>
                            ...
                            <tr>
                                <td>5611</td>
                                <td>
                                    Men's and Boys' Clothing and Accessory Stores (clothing
                                    stores)
                                </td>
                                <td>448110</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    activities performed on a contract or fee basis and
                            ...
                            <tr>
                                <td>1081</td>
                                <td>
                                    Metal Mining Services (site preparation and related
                                    construction activities on a contract basis)
                                </td>
                                <td>238910</td>
                                <td>Site Preparation Contractors</td>
                            ...
                            <tr>
                                <td>3469</td>
                                <td>
                                    Metal Stampings, NEC (except kitchen utensils, pots and pans
                                    for cooking, coins, and stamped metal boxes)
                                </td>
                                <td>332116</td>
                            ...
                            <tr>
                                <td>3469</td>
                                <td>
                                    Metal Stampings, NEC (stamped metal tool, cash, mail, and
                                    lunch boxes)
                                </td>
                                <td>332439</td>
                                <td>Other Metal Container Manufacturing</td>
                            ...
                            <tr>
                                <td>5699</td>
                                <td>
                                    Miscellaneous Apparel and Accessory Stores (accessories)
                                </td>
                                <td>448150</td>
                                <td>Clothing Accessories Stores</td>
                            </tr>
                            <tr>
                                <td>5699</td>
                                <td>
                                    Miscellaneous Apparel and Accessory Stores (custom
                                    dressmakers)
                                </td>
                                <td>315233</td>
                                <td>Women's and Girls' Cut and Sew Dress Manufacturing</td>
                            ...
                            <tr>
                                <td>6159</td>
                                <td>
                                    Miscellaneous Business Credit Institutions (except trade
                                    banks, farm mortgage companies, secondary market financing,
                                    and finance leasing combined with sales financing)
                                </td>
                                <td>522298</td>
                                <td>All Other Nondepository Credit Intermediation</td>
                            </tr>
                            ...
                            <tr>
                                <td>6159</td>
                                <td>
                                    Miscellaneous Business Credit Institutions (trade banks)
                                </td>
                                <td>522293</td>
                                <td>International Trade Financing</td>
                            </tr>
                            ...
                            <tr>
                                <td>3496</td>
                                <td>
                                    Miscellaneous Fabricated Wire Products (shopping carts made
                                    from purchased wire)
                                </td>
                                <td>333924</td>
                                <td>
                            ...
                            <tr>
                                <td>5499</td>
                                <td>
                                    Miscellaneous Food Stores (poultry and poultry products)
                                </td>
                                <td>445210</td>
                                <td>Meat Markets</td>
                            </tr>
                            <tr>
                                <td>5399</td>
                                <td>
                                    Miscellaneous General Merchandise Stores (except warehouse
                            ...
                            <tr>
                                <td>5719</td>
                                <td>
                                    Miscellaneous Homefurnishings Stores (blinds and shades)
                                </td>
                                <td>442291</td>
                                <td>Window Treatment Stores</td>
                            </tr>
                            <tr>
                                <td>5719</td>
                                <td>
                                    Miscellaneous Homefurnishings Stores (except pottery and
                                    crafts made and sold on site and window furnishings){" "}
                                </td>
                                <td>442299</td>
                            ...
                            <tr>
                                <td>5719</td>
                                <td>
                                    Miscellaneous Homefurnishings Stores (manufacturing and
                            ...
                            <tr>
                                <td>0919</td>
                                <td>
                                    Miscellaneous Marine Products (cultured pearl production)
                                </td>
                                <td>112512</td>
                                <td>Shellfish Farming</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    consumer bartering services, and formal wear and costume
                                    rental)
                                </td>
                                <td>812990</td>
                                <td>All Other Personal Services</td>
                            ...
                            <tr>
                                <td>2741</td>
                                <td>
                                    Miscellaneous Publishing (directory publishers, except
                                    Internet publishers)
                                </td>
                                <td>511140</td>
                                <td>Directory and Mailing List Publishers</td>
                            ...
                            <tr>
                                <td>2741</td>
                                <td>
                                    Miscellaneous Publishing (technical manuals and books
                            ...
                            <tr>
                                <td>5999</td>
                                <td>
                                    Miscellaneous Retail Stores, NEC (cosmetics and perfumes)
                                </td>
                                <td>446120</td>
                                <td>Cosmetics, Beauty Supplies, and Perfume Stores</td>
                            </tr>
                            ...
                            <tr>
                                <td>3714</td>
                                <td>
                                    Motor Vehicle Parts and Accessories (gasoline engines and
                            ...
                            <tr>
                                <td>3714</td>
                                <td>
                                    Motor Vehicle Parts and Accessories (wiring harness sets,
                                    other than ignition; block heaters and battery heaters;
                                    instrument board assemblies; permanent defrosters; windshield
                                    washer-wiper mechanisms; cruise control mechanisms; and other
                            ...
                            <tr>
                                <td>5013</td>
                                <td>
                                    Motor Vehicle Supplies and New Parts (agents and brokers)
                                </td>
                                <td>425120</td>
                                <td>Wholesale Trade Agents and Brokers</td>
                            </tr>
                            <tr>
                                <td>5013</td>
                                <td>
                                    Motor Vehicle Supplies and New Parts (auto parts sold via
                                    retail method)
                                </td>
                                <td>441310</td>
                                <td>Automotive Parts and Accessories Stores</td>
                            ...
                            <tr>
                                <td>2241</td>
                                <td>
                                    Narrow Fabric and Other Smallware Mills: Cotton, Wool, Silk
                                    and Manmade Fiber
                                </td>
                                <td>313221</td>
                            ...
                            <tr>
                                <td>7383</td>
                                <td>
                                    News Syndicates (except independent news correspondents)
                                </td>
                                <td>519110</td>
                            ...
                            <tr>
                                <td>8733</td>
                                <td>
                                    Noncommercial Research Organizations (physical, engineering,
                                    and life sciences)
                                </td>
                                <td>541712</td>
                                <td>
                            ...
                            <tr>
                                <td>3644</td>
                                <td>
                                    Noncurrent-Carrying Wiring Devices (except fishwire,
                            ...
                            <tr>
                                <td>3644</td>
                                <td>
                                    Noncurrent-Carrying Wiring Devices (fish wire, electrical
                                    wiring tool)
                                </td>
                                <td>332212</td>
                                <td>Hand and Edge Tool Manufacturing</td>
                            ...
                            <tr>
                                <td>5199</td>
                                <td>
                                    Nondurable Goods, NEC (business to business electronic
                                    markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    merchant wholesalers selling miscellaneous nondurable goods
                                    via the retail method)
                                </td>
                                <td>424990</td>
                                <td>
                            ...
                            <tr>
                                <td>5199</td>
                                <td>
                                    Nondurable Goods, NEC (pets, pet supplies and tropical fish
                                    sold via retail method)
                                </td>
                                <td>453910</td>
                                <td>Pet and Pet Supplies Stores</td>
                            ...
                            <tr>
                                <td>5199</td>
                                <td>
                                    Nondurable Goods, NEC (smokers' supplies sold via retail
                                    method)
                                </td>
                                <td>453991</td>
                            ...
                            <tr>
                                <td>1481</td>
                                <td>
                                    Nonmetallic Minerals Services, Except Fuels (except
                                    geophysical surveying and mapping and site preparation and
                                    related construction activities performed on a contract or fee
                                    basis)
                                </td>
                                <td>213115</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    care retirement communities, psychiatric convalescent homes
                                    with health care, and homes for the mentally retarded with
                                    health care)
                                </td>
                                <td>623110</td>
                                <td>Nursing Care Facilities</td>
                            ...
                            <tr>
                                <td>8011</td>
                                <td>
                                    Offices and Clinics of Doctors of Medicine (ambulatory
                            ...
                            <tr>
                                <td>8011</td>
                                <td>
                                    Offices and Clinics of Doctors of Medicine (except mental
                                    health specialists, HMO medical centers, and ambulatory
                                    surgical and emergency centers)
                                </td>
                                <td>621111</td>
                                <td>
                            ...
                            <tr>
                                <td>8011</td>
                                <td>
                                    Offices and Clinics of Doctors of Medicine (HMO Medical
                                    Centers)
                                </td>
                                <td>621491</td>
                            ...
                            <tr>
                                <td>8049</td>
                                <td>
                                    Offices and Clinics of Health Practitioners, NEC (except
                                    mental health practitioners, physical, occupational, speech
                            ...
                            <tr>
                                <td>8049</td>
                                <td>
                                    Offices and Clinics of Health Practitioners, NEC (mental
                                    health practitioners except physicians)
                                </td>
                                <td>621330</td>
                                <td>
                            ...
                            <tr>
                                <td>1389</td>
                                <td>
                                    Oil and Gas Field Services, NEC (construction of field
                            ...
                            <tr>
                                <td>6512</td>
                                <td>
                                    Operators of Nonresidential Buildings (except stadium and
                                    arena owners)
                                </td>
                                <td>531120</td>
                                <td>
                            ...
                            <tr>
                                <td>6512</td>
                                <td>
                                    Operators of Nonresidential Buildings (stadium and arena
                                    owners)
                                </td>
                                <td>711310</td>
                                <td>
                            ...
                            <tr>
                                <td>3851</td>
                                <td>
                                    Ophthalmic Goods (intraoccular lenses, i.e., surgical
                                    implants)
                                </td>
                                <td>339113</td>
                                <td>Surgical Appliance and Supplies Manufacturing</td>
                            ...
                            <tr>
                                <td>5995</td>
                                <td>
                                    Optical Goods Stores (except labs grinding prescription
                                    lenses)
                                </td>
                                <td>446130</td>
                            ...
                            <tr>
                                <td>5142</td>
                                <td>
                                    Packaged Frozen Foods (business to business electronic
                                    markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>5142</td>
                                <td>
                                    Packaged Frozen Foods (merchant wholesalers except those
                                    selling packaged frozen foods via retail method)
                                </td>
                                <td>424420</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    (except single-web and multi-web plastics packaging film and
                                    sheet)
                                </td>
                                <td>322221</td>
                                <td>
                            ...
                            <tr>
                                <td>5198</td>
                                <td>
                                    Paints, Varnishes, and Supplies (business to business
                                    electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>6141</td>
                                <td>
                                    Personal Credit Institutions (except installment sales
                                    finance, industrial nondeposit banks, and credit card issuing)
                                </td>
                                <td>522291</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Petroleum and Petroleum Products Wholesalers, Except Bulk
                                    Stations and Terminals (business to business electronic
                                    markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>5171</td>
                                <td>
                                    Petroleum Bulk Stations and Terminals (except petroleum sold
                                    via retail method)
                                </td>
                                <td>424710</td>
                            ...
                            <tr>
                                <td>5171</td>
                                <td>
                                    Petroleum Bulk Stations and Terminals (heating oil sold to
                                    final consumer)
                                </td>
                                <td>454311</td>
                                <td>Heating Oil Dealers</td>
                            ...
                            <tr>
                                <td>3861</td>
                                <td>
                                    Photographic Equipment and Supplies (photographic films,
                                    paper, plates and chemicals)
                                </td>
                                <td>325992</td>
                                <td>
                            ...
                            <tr>
                                <td>5131</td>
                                <td>
                                    Piece Goods, Notions, and Other Dry Goods (business to
                                    business electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    wholesalers except broadwoven and piece goods converters and
                                    merchant wholesalers selling piece goods, notions and other
                                    dry goods via retail method)
                                </td>
                                <td>424310</td>
                                <td>
                                    Piece Goods, Notions, and Other Dry Goods Merchant Wholesalers
                            ...
                            <tr>
                                <td>3089</td>
                                <td>
                                    Plastics Products, NEC (finished plastic furniture parts)
                                </td>
                                <td>337215</td>
                                <td>Showcase, Partition, Shelving, and Locker Manufacturing</td>
                            </tr>
                            ...
                            <tr>
                                <td>2673</td>
                                <td>
                                    Plastics, Foil, and Coated Paper Bags (single-web and
                            ...
                            <tr>
                                <td>2395</td>
                                <td>
                                    Pleating, Decorative and Novelty Stitching, and Tucking for
                                    the Trade (except apparel contractors)
                                </td>
                                <td>314999</td>
                                <td>All Other Miscellaneous Textile Product Mills</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Pleating, Decorative and Novelty Stitching, and Tucking for
                                    the Trade (men's and boy's apparel contractors)
                                </td>
                                <td>315211</td>
                                <td>Men's and Boys' Cut and Sew Apparel Contractors</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Pleating, Decorative and Novelty Stitching, and Tucking for
                                    the Trade (women's, girls', and infants' apparel contractors)
                                </td>
                                <td>315212</td>
                                <td>
                                    Women's, Girls', and Infants' Cut and Sew Apparel Contractors
                            ...
                            <tr>
                                ...
                                <td>
                                    Plumbing and Heating Equipment and Supplies (Hydronics)
                                    (merchant wholesalers except those selling plumbing and
                                    hydronic heating equipment via retail method)
                                </td>
                                <td>423720</td>
                                <td>
                                    Plumbing and Heating Equipment and Supplies (Hydronics)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    (Hydronics)(plumbing and hydronic heating equipment sold via
                                    retail method)
                                </td>
                                <td>444190</td>
                                <td>Other Building Material Dealers</td>
                            ...
                            <tr>
                                <td>1711</td>
                                <td>
                                    Plumbing, Heating, and Air-Conditioning (septic tank,
                            ...
                            <tr>
                                <td>5144</td>
                                <td>
                                    Poultry and Poultry Products (merchant wholesalers except
                                    those selling poultry and poultry products via retail method)
                                </td>
                                <td>424440</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Except Dogs and Cats (except slaughtering animals for pet
                                    food)
                                </td>
                                <td>311119</td>
                                <td>Other Animal Food Manufacturing</td>
                            ...
                            <tr>
                                <td>3399</td>
                                <td>
                                    Primary Metal Products, NEC (copper powder, paste, flakes,
                                    etc.)
                                </td>
                                <td>331423</td>
                            ...
                            <tr>
                                <td>3399</td>
                                <td>
                                    Primary Metal Products, NEC (iron ore recovery from open
                                    hearth slag)
                                </td>
                                <td>331111</td>
                            ...
                            <tr>
                                <td>5111</td>
                                <td>
                                    Printing and Writing Paper (printing and writing paper sold
                                    via retail method)
                                </td>
                                <td>453210</td>
                                <td>Office Supplies and Stationary Stores</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    except those selling religious and teacher's school supplies
                                    via retail method){" "}
                                </td>
                                <td>423490</td>
                                <td>
                            ...
                            <tr>
                                <td>2531</td>
                                <td>
                                    Public Building and Related Furniture (seats for motor
                                    vehicles)
                                </td>
                                <td>336360</td>
                                <td>Motor Vehicle Seating and Interior Trim Manufacturing</td>
                            ...
                            <tr>
                                <td>2611</td>
                                <td>
                                    Pulp Mills (pulp mills producing paper except newsprint)
                                </td>
                                <td>322121</td>
                                <td>Paper (except Newsprint) Mills</td>
                            </tr>
                            ...
                            <tr>
                                <td>6531</td>
                                <td>
                                    Real Estate Agents and Managers (operating housing
                                    authorities)
                                </td>
                                <td>531110</td>
                                <td>Lessors of Residential Buildings and Dwellings</td>
                            ...
                            <tr>
                                <td>6531</td>
                                <td>
                                    Real Estate Agents and Managers (residential property
                                    managers)
                                </td>
                                <td>531311</td>
                            ...
                            <tr>
                                <td>6798</td>
                                <td>
                                    Real Estate Investment Trusts (hybrid or equity REITs
                            ...
                            <tr>
                                ...
                                <td>
                                    Refrigeration and Air-Conditioning Services and Repair Shops
                                    (new retail sales combined with repair-repair services as
                            ...
                            <tr>
                                <td>4953</td>
                                <td>
                                    Refuse Systems (other nonhazardous waste treatment and
                                    disposal)
                                </td>
                                <td>562219</td>
                            ...
                            <tr>
                                <td>4741</td>
                                <td>
                                    Rental of Railroad Cars (grain leveling in railroad cars,
                                    grain trimming for railroad equipment, precooling of fruits
                                    and vegetables in connection with transportation, and railroad
                                    car cleaning, icing, ventilating, and heating)
                                </td>
                                <td>488210</td>
                                <td>Support Activities for Rail Transportation</td>
                            </tr>
                            ...
                            <tr>
                                <td>7699</td>
                                <td>
                                    Repair Shops and Related Services, NEC (cesspool and septic
                                    tank cleaning)
                                </td>
                                <td>562991</td>
                                <td>Septic Tank and Related Services</td>
                            ...
                            <tr>
                                <td>7699</td>
                                <td>
                                    Repair Shops and Related Services, NEC (lawnmower repair
                                    shops, sharpening and repairing knives, saws and tools)
                                </td>
                                <td>811411</td>
                            ...
                            <tr>
                                <td>7699</td>
                                <td>
                                    Repair Shops and Related Services, NEC (new bicycle retail
                                    sales combined with repair-repair services for bicycles as
                                    major source of receipts)
                                </td>
                                <td>451110</td>
                                <td>Sporting Goods Stores</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    transportation equipment and industrial machines and
                                    equipment, and sharpening commercial blades)
                                </td>
                                <td>811310</td>
                                <td>
                                    Commercial and Industrial Machinery and Equipment (except
                            ...
                            <tr>
                                <td>7699</td>
                                <td>
                                    Repair Shops and Related Services, NEC (taxidermists and
                                    antique repair and restoration, except antique car
                                    restoration)
                                </td>
                                <td>711510</td>
                                <td>Independent Artists, Writers, and Performers</td>
                            ...
                            <tr>
                                <td>8361</td>
                                <td>
                                    Residential Care (mental health and substance abuse
                                    facilities){" "}
                                </td>
                                <td>623220</td>
                                <td>
                            ...
                            <tr>
                                <td>5461</td>
                                <td>
                                    Retail Bakeries (bread, cake and related products baked and
                                    sold on premise)
                                </td>
                                <td>311811</td>
                            ...
                            <tr>
                                <td>5261</td>
                                <td>
                                    Retail Nurseries, Lawn and Garden Supply Stores (except
                            ...
                            <tr>
                                <td>5033</td>
                                <td>
                                    Roofing, Siding, and Insulation Materials (business to
                                    business electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                <td>5033</td>
                                <td>
                                    Roofing, Siding, and Insulation Materials (merchant
                            ...
                            <tr>
                                <td>5033</td>
                                <td>
                                    Roofing, Siding, and Insulation Materials (roofing, siding,
                                    and insulation materials sold via retail method)
                                </td>
                                <td>444190</td>
                                <td>Other Building Material Dealers</td>
                            </tr>
                            <tr>
                                <td>1761</td>
                                <td>
                                    Roofing, Siding, and Sheet Metal Work (except roofing and
                                    siding work)
                                </td>
                                <td>238390</td>
                            ...
                            <tr>
                                <td>2013</td>
                                <td>
                                    Sausages and Other Prepared Meat Products (except lard made
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    purchased lumber, softwood cut stock, wood lath, fence
                                    pickets, and planing mill products)
                                </td>
                                <td>321912</td>
                                <td>Cut Stock, Resawing Lumber, and Planing</td>
                            </tr>
                            ...
                            <tr>
                                <td>8299</td>
                                <td>
                                    Schools and Educational Services, NEC (baton instruction)
                                </td>
                                <td>611620</td>
                                <td>Sports and Recreation Instruction</td>
                            </tr>
                            ...
                            <tr>
                                <td>8299</td>
                                <td>
                                    Schools and Educational Services, NEC (language schools)
                                </td>
                                <td>611630</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    security dealers and underwriters, and security, oil lease,
                                    and gas lease brokers)
                                </td>
                                <td>523910</td>
                                <td>Miscellaneous Intermediation</td>
                            </tr>
                            ...
                            <tr>
                                <td>5087</td>
                                <td>
                                    Service Establishment Equipment and Supplies (beauty and
                                    barber shop equipment and supplies sold via retail method)
                                </td>
                                <td>446120</td>
                                <td>Cosmetics, Beauty Supplies, and Perfume Stores</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    bureaus, wardrobe and equipment rental, talent payment
                                    services, teleproduction and other postproduction services,
                                    reproduction of videos, independent film directors, and other
                                    independent motion picture production related services)
                                </td>
                                <td>512199</td>
                                <td>Other Motion Picture and Video Industries</td>
                            </tr>
                            <tr>
                                <td>7819</td>
                                <td>
                                    Services Allied to Motion Picture Production (film directors
                                    and related motion picture production services, independent)
                                </td>
                                <td>711510</td>
                                <td>Independent Artists, Writers, and Performers</td>
                            </tr>
                            ...
                            <tr>
                                <td>7819</td>
                                <td>
                                    Services Allied to Motion Picture Production (teleproduction
                            ...
                            <tr>
                                <td>8999</td>
                                <td>
                                    Services, NEC (authors, artists, and related technical
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    (short term inventory credit and purchasing accounts
                                    receivable)
                                </td>
                                <td>522298</td>
                                <td>All Other Nondepository Credit Intermediation</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    edible cooking oils from oilseeds and vegetables crushed in
                            ...
                            <tr>
                                ...
                                <td>
                                    Shortening, Table Oils, Margarine, and Other Edible Fats and
                                    Oils, NEC (processing soybean oil into edible cooking oils
                                    from soybeans crushed in the same establishment)
                                </td>
                                <td>311222</td>
                            ...
                            <tr>
                                <td>1799</td>
                                <td>
                                    Special Trade Contractors, NEC (building equipment
                                    installation contractors for service station equipment;
                                    boiler, duct, and pipe insulation; lightning rod installation;
                                    bowling alley equipment installation; church bell
                                    installation; and clock tower installation)
                                </td>
                                <td>238290</td>
                                <td>Other Building Equipment Contractors</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    for weather stripping and damp proofing, window covering
                                    fixture installation, bathtub refinishing, modular furniture
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    contractors; anchored earth retention contractors; glass
                                    tinting work; forming contractors; ornamental metal work
                                    contractors; lightning rod installation contractors; paint and
                                    wall paper removal contractors; countertop, residential-type,
                                    installation; miscellaneous residential building finishing
                                    contractors; dewatering contractors; test drilling for
                                    construction; and core drilling for construction)
                                </td>
                                <td>238990</td>
                                <td>All Other Specialty Trade Contractors</td>
                            </tr>
                            ...
                            <tr>
                                <td>8093</td>
                                <td>
                                    Specialty Outpatient Facilities, NEC (mental health
                                    facilities)
                                </td>
                                <td>621420</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Sporting and Recreational Goods and Supplies (merchant
                                    wholesalers except those selling sporting and recreational
                                    goods via retail method)
                                </td>
                                <td>423910</td>
                                <td>
                            ...
                            <tr>
                                <td>5112</td>
                                <td>
                                    Stationery and Office Supplies (business to business
                                    electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    those selling stationery and office supplies via retail
                                    method)
                                </td>
                                <td>424120</td>
                            ...
                            <tr>
                                <td>2299</td>
                                <td>
                                    Textile Goods, NEC (broadwoven fabrics of jute, linen, hemp,
                                    and ramie and hand woven fabrics)
                                </td>
                                <td>313210</td>
                                <td>Broadwoven Fabric Mills</td>
                            </tr>
                            <tr>
                                <td>2299</td>
                                <td>
                                    Textile Goods, NEC (finishing hard fiber thread and yarn
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Theatrical Services (casting agencies and television
                                    employment agencies)
                                </td>
                                <td>561311</td>
                                <td>Employment Placement Agencies</td>
                            ...
                            <tr>
                                <td>7534</td>
                                <td>
                                    Tire Retreading and Repair Shops (rebuilding tires and
                                    retreaded tire manufacturing)
                                </td>
                                <td>326212</td>
                            ...
                            <tr>
                                <td>5014</td>
                                <td>
                                    Tires and Tubes (business to business electronic markets)
                                </td>
                                <td>425110</td>
                                <td>Business to Business Electronic Markets</td>
                            </tr>
                            ...
                            <tr>
                                <td>5194</td>
                                <td>
                                    Tobacco and Tobacco Products (merchant wholesalers except
                                    those selling tobacco and tobacco products via retail method)
                                </td>
                                <td>424940</td>
                            ...
                            <tr>
                                <td>3799</td>
                                <td>
                                    Transportation Equipment, NEC (except automobile, boat,
                            ...
                            <tr>
                                <td>4789</td>
                                <td>
                                    Transportation Services, NEC (dining car operations on a fee
                                    or contract basis)
                                </td>
                                <td>722310</td>
                                <td>Food Service Contractors</td>
                            ...
                            <tr>
                                <td>4789</td>
                                <td>
                                    Transportation Services, NEC (pipeline terminals and
                            ...
                            <tr>
                                <td>3494</td>
                                <td>
                                    Valves and Pipe Fittings, NEC (metal pipe hangers and
                                    supports)
                                </td>
                                <td>332999</td>
                                <td>
                            ...
                            <tr>
                                <td>8249</td>
                                <td>
                                    Vocational Schools, NEC (except aviation and flight training
                            ...
                            <tr>
                                <td>7631</td>
                                <td>
                                    Watch, Clock, and Jewelry Repair (new retail sales combined
                                    with repair-repair services as major source of receipts)
                                </td>
                                <td>448310</td>
                                <td>Jewelry Stores</td>
                            ...
                            <tr>
                                <td>4499</td>
                                <td>
                                    Water Transportation Services, NEC (piloting vessels in and
                                    out of harbors and marine salvage)
                                </td>
                                <td>488330</td>
                                <td>Navigational Services to Shipping</td>
                            </tr>
                            ...
                            <tr>
                                <td>2385</td>
                                <td>
                                    Waterproof Outerwear (women's, girls', and infants'
                                    contractors)
                                </td>
                                <td>315212</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Women's, Children's and Infants' Clothing and Accessories
                                    (selling a general line of children's and infants' clothing
                                    via retail method)
                                </td>
                                <td>448130</td>
                                <td>Children's and Infants' Clothing Stores</td>
                            ...
                            <tr>
                                <td>2499</td>
                                <td>
                                    Wood Products, NEC (except wood containers, wood cooling
                                    towers, cork life preservers, mirror or picture frames, and
                                    laundry hampers of reed, rattan, and willow)
                                </td>
                                <td>321999</td>
                                <td>All Other Miscellaneous Wood Product Manufacturing</td>
                            </tr>
                            <tr>
                                <td>2499</td>
                                <td>
                                    Wood Products, NEC (laundry hampers of reed, rattan, and
                                    willow)
                                </td>
                                <td>337125</td>
                                <td>
                            ...
                            <tr>
                                <td>2517</td>
                                <td>
                                    Wood Television, Radio, Phonograph, and Sewing Machine
                                    Cabinets
                                </td>
                                <td>337129</td>
                                <td>
