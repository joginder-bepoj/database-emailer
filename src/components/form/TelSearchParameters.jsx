                ...
                <div className="floatleft" id="SCF" align="left">
                    ...
                    >
                        ...
                        <optgroup label="&nbsp;&nbsp;California" className="optGroupSCF">
                            ...
                            <option value="917">917 | RANCHO CUCAMONGA, CA | 621,710</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;Colorado" className="optGroupSCF">
                            ...
                            <option value="809">809 | COLORADO SPRINGS, CO | 204,361</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;Florida" className="optGroupSCF">
                            <option value="327">327 | ALTAMONTE SPRINGS, FL | 390,792</option>
                            ...
                            <option value="337">337 | SAINT PETERSBURG, FL | 304,430</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;Georgia" className="optGroupSCF">
                            ...
                            <option value="300">300 | AVONDALE ESTATES, GA | 846,109</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;Illinois" className="optGroupSCF">
                            ...
                            <option value="622">622 | EAST SAINT LOUIS, IL | 187,335</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;Michigan" className="optGroupSCF">
                            ...
                            <option value="483">483 | BLOOMFIELD HILLS, MI | 433,916</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;Minnesota" className="optGroupSCF">
                            ...
                            <option value="567">567 | THIEF RIVER FALLS, MN | 28,275</option>
                        ...
                        <optgroup label="&nbsp;&nbsp;New Hampshire" className="optGroupSCF">
                            ...
                            <option value="032">032 | WATERVILLE VALLEY, NH | 78,508</option>
                        </optgroup>
                        ...
                        <optgroup label="&nbsp;&nbsp;New York" className="optGroupSCF">
                            ...
                            <option value="121">121 | TROY, RENSSELAER, NY | 122,917</option>
