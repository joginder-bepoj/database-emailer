...
const UniqueEmailFax = () => {
  ...
  return (
    <>
      {location.pathname === "/database-emailer/checklinkedin" ? (
        ...
        <fieldset id="fsUniques">
          ...
          <table width="100%">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <label htmlFor="chkEmailsOrPhones">
                    Must Include Email OR Phone
                  </label>
                </td>
                <td align="center">
                  <input
          ...
          &nbsp;If you check the "Unique Email Addresses" or "Unique Fax
          Numbers" below, then you don't need to check the boxes above too.
          NOTE: We have over 80 million full records and 60 million of them have
          email addresses. However, most email records do NOT have values for
          the following two select options, so choosing them will greatly limit
          your email count.
        </fieldset>
      )}
    </>
