            ...
            <table className="tdBlock" id="tblMain">
                    ...
                    <td>
                        ...
                        <fieldset id="fsDOB">
                            ...
                            >
                                ...
                                <tr valign="top">
                                    <td>
                                        <select onChange={handleChange} name="ageLower" id="ageLower">
                                    ...
                                    <td>
                                        <select onChange={handleChange} name="ageUpper" id="ageUpper">
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="EDUCATION-2">Completed Graduate School</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="EDUCATION-3">Completed High School</label>
                                    </td>
                                </tr></tbody>
                            </table>
                            <hr />
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="BUSINESS_OWNER-4">Distributor/Wholesaler</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="BUSINESS_OWNER-5">Funeral Director</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="BUSINESS_OWNER-6">Maker/Manufacturer</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-1">Clerical / White Collar</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-2">Craftsman / Blue Collar</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-5">Financial Professional</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-8">Medical Professional</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-11">Professional / Technical</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-19">Self Employed - Homemaker</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-20">Self Employed - Other</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-22">Self Employed - Retired</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION-24">Self Employed - Student</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                    ...
                    <td colSpan="2">
                        <fieldset className="stateLabel" id="fsOCCUPATION_DETAILED">
                            ...
                            >
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-0">Account Executive</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Advertising"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-5">Advertising</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-7">Aide/Assistant</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Air Force"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-13">Air Force</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Appraiser"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-17">Appraiser</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Apprentice"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-18">Apprentice</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Architect"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-19">Architect</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Armed Forces"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-20">Armed Forces</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Assembler"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-23">Assembler</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Attendant"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-25">Attendant</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Auctioneer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-26">Auctioneer</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Auto Mechanic"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-28">Auto Mechanic</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Bartender"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-34">Bartender</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Bookkeeper"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-38">Bookkeeper</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Chef/Butler"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-50">Chef/Butler</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Chiropractor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-53">Chiropractor</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Civil Service"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-54">Civil Service</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-57">Cleaner/Laundry</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Clerk/Deli"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-59">Clerk/Deli</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Clerk/File"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-60">Clerk/File</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Clerk/Produce"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-61">Clerk/Produce</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Clerk/Stock"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-62">Clerk/Stock</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Coast Guard"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-64">Coast Guard</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Collector"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-65">Collector</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-66">Communications</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Comptroller"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-67">Comptroller</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Conductor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-72">Conductor</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Construction"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-74">Construction</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Coordinator"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-77">Coordinator</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Cosmetologist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-79">Cosmetologist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Counselor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-80">Counselor</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-82">Court Reporter</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Custodian"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-85">Custodian</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-89">Dental Assistant</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-90">Dental Hygienist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Dietician"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-94">Dietician</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Dispatcher"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-97">Dispatcher</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Dock Worker"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-98">Dock Worker</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Draftsman"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-99">Draftsman</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Electrician"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-104">Electrician</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Engineer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-105">Engineer</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-108">Engineer/Civil</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-110">Engineer/Field</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Estimator"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-113">Estimator</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Expeditor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-115">Expeditor</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Fabricator"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-116">Fabricator</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-117">Factory Workman</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-118">Farmer/Dairyman</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Finisher"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-120">Finisher</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Firefighter"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-121">Firefighter</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Food Service"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-126">Food Service</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Forestry"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-129">Forestry</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-130">Foundry Worker</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Geologist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-133">Geologist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Health Care"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-138">Health Care</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-139">Health Services</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-141">Home Economist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Homemaker"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-142">Homemaker</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Inspector"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-145">Inspector</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Installer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-146">Installer</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Instructor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-147">Instructor</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-148">Insurance/Agent</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Ironworker"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-151">Ironworker</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Journeyman"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-154">Journeyman</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Judge/Referee"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-155">Judge/Referee</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Lecturer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-157">Lecturer</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-158">Legal Secretary</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Lithographer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-163">Lithographer</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Locksmith"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-165">Locksmith</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Machinist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-166">Machinist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-168">Mail/Postmaster</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Maintenance"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-169">Maintenance</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Marketing"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-190">Marketing</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Mechanic"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-193">Mechanic</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Merchandiser"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-199">Merchandiser</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Meter Reader"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-200">Meter Reader</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Mill worker"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-202">Mill worker</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Millwright"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-203">Millwright</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-208">National Guard</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Nurse/LPN"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-212">Nurse/LPN</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Operator"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-215">Operator</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Optician"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-220">Optician</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Optometrist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-221">Optometrist</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Part Time"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-224">Part Time</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Photography"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-229">Photography</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Pipe fitter"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-231">Pipe fitter</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-234">Police/Trooper</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Polisher"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-235">Polisher</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="President"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-238">President</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-239">Press Operator</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Production"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-243">Production</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Professional"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-244">Professional</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Professor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-245">Professor</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Psychologist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-246">Psychologist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Publishing"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-248">Publishing</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Purchasing"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-249">Purchasing</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-250">Quality Control</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Receptionist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-252">Receptionist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Repairman"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-253">Repairman</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Reporter"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-254">Reporter</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Researcher"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-255">Researcher</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Scientist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-262">Scientist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Secretary"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-264">Secretary</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Security"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-265">Security</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Setup man"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-266">Setup man</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-273">Superintendent</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Supervisor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-274">Supervisor</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Surveyor"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-275">Surveyor</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Technician"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-277">Technician</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-278">Technician/Lab</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Therapist"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-283">Therapist</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Toolmaker"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-285">Toolmaker</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-288">Transportation</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Travel Agent"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-289">Travel Agent</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Treasurer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-290">Treasurer</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Typesetter"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-291">Typesetter</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Upholstery"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-294">Upholstery</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Veterinarian"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-296">Veterinarian</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-297">Vice President</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                            ...
                                            value="Volunteer"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-298">Volunteer</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-299">Waiter/Waitress</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Ward Clerk"
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-300">Ward Clerk</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="OCCUPATION_DETAILED-301">Water Treatment</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />{" "}
                            <label htmlFor="OCCUPATION_DETAILED_OR">Any Match On These</label>
                        </fieldset>
                        /
                    </td>
                </tr>
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="LANGUAGE-39">Laotian (Include Hmong)</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="ETHNIC_CODE-1">African American 1</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                        ...
                                        />{" "}
                                        <label htmlFor="ETHNIC_CODE-2">African American 2</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="ETHNIC_CODE-111">Papua New Guinea</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="ETHNIC_GROUP-1">Central + SW Asian</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="ETHNIC_GROUP-8">Miscellaneous Other</label>
                                    </td>
                                    <td>
                                        <input onChange={handleChange}
                                            type="checkbox"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />{" "}
                                        <label htmlFor="ETHNIC_GROUP-15">Western European</label>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <tr>
                    <td>
                        <fieldset>
                            ...
                            <select onChange={handleChange} name="NUMBER_OF_CHILDREN" id="NUMBER_OF_CHILDREN">
                                ...
                                <option value="1 to 6">1 to 6</option>
                                <option value="1 to 7">1 to 7</option>
                                <option value="1 to 8 and More">1 to 8 and More</option>
                            </select>
                            <hr />
                            <input onChange={handleChange}
                                type="radio"
                    ...
                    <td>
                        <fieldset id="fsPRESENCE_OF_CHILDREN">
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />
                            <label htmlFor="PRESENCE_OF_CHILDREN_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                </tr>
                <tr>
                ...
                <tr valign="top">
                    <td width="50%">
                        <fieldset>
                            ...
                            <br />
                            <select onChange={handleChange} name="INCOME_ESTIMATED_HH" id="INCOME_ESTIMATED_HH">
                    ...
                    <td colSpan="2" align="center">
                        <div style={{ border: "2px solid grey", borderTopWidth: "0" }}>
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />{" "}
                            <label htmlFor="INCOME_ESTIMATED_HH_OR">Any Match On This</label>
                        </div>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <small>(optional)</small>
                            <br />
                            <select onChange={handleChange} name="NET_WORTH_UPPER" id="NET_WORTH_UPPER">
                                <option value="">Select Estimated Net Worth Upper Range</option>
                                <option value="1 - 5K">1 - 5K</option>
                                <option value="5K - 10K">5K - 10K</option>
                                <option value="10K - 25K">10K - 25K</option>
                                <option value="25K - 50K">25K - 50K</option>
                ...
                <tr valign="top">
                    <td width="50%">
                        <fieldset>
                            ...
                            <small>Lower Range or Exact Value</small>
                            <br />
                            <select onChange={handleChange} name="CREDIT_RATING" id="CREDIT_RATING">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <small>(optional)</small>
                            <br />
                            <select onChange={handleChange} name="CREDIT_RATING_UPPER" id="CREDIT_RATING_UPPER">
                    ...
                    <td>
                        <fieldset className="stateLabel" id="fsADDRESS_TYPE_INDICATOR">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Rural Route"
                                        />{" "}
                                        <label htmlFor="ADDRESS_TYPE_INDICATOR-3">Rural Route</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input onChange={handleChange}
                                            ...
                                            value="Undetermined"
                                        />{" "}
                                        <label htmlFor="ADDRESS_TYPE_INDICATOR-5">Undetermined</label>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="ADDRESS_TYPE_INDICATOR_AND">All Must Match</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="ADDRESS_TYPE_INDICATOR_AND_OR"
                                ...
                                value="1"
                            />{" "}
                            <label htmlFor="ADDRESS_TYPE_INDICATOR_OR">Any Match On These</label>
                        </fieldset>
                    </td>
                    <td>
                        {" "}
                        <fieldset>
                            ...
                            <br />
                            <select onChange={handleChange} name="LENGTH_OF_RESIDENCE" id="LENGTH_OF_RESIDENCE">
                                <option defaultValue="">
                            ...
                            <input onChange={handleChange} type="radio" name="Years_Residence" id="EQU" value="-1" />
                            <br />
                            <label htmlFor="GTY">Greater Than or Equal To in Years</label>{" "}
                            <input onChange={handleChange} type="radio" name="Years_Residence" id="GTY" value="1" />
                            <br />
                            <hr />
                            <br />
                            <label htmlFor="LENGTH_OF_RESIDENCE_AND">All Must Match</label>{" "}
                            <input onChange={handleChange}
                                type="radio"
                                ...
                                defaultChecked
                            />{" "}
                            |<label htmlFor="LENGTH_OF_RESIDENCE_OR">Any Match On This</label>{" "}
                            <input onChange={handleChange}
                                type="radio"
                                name="LENGTH_OF_RESIDENCE_AND_OR"
                ...
                <tr>
                    <td colSpan="2">
                        ...
                        <fieldset>
                            <legend>
                                Select Records Based on Homeowners 1<sup>st</sup> Mortgage Date:
                            </legend>
                            <span className="elevfont">
                                Include in only records that have mortgage from an earlier date
                            ...
                            <table width="100%" cellPadding="10" cellSpacing="2">
                                ...
                                <tr valign="top">
                                    <td align="center">
                                        ...
                                        <select onChange={handleChange} name="mortgage_date" id="mortgage_date">
                                            <option
                                                value=""
                                    ...
                                    <td align="center" width="49%">
                                        ...
                                        <select onChange={handleChange} name="mortgage_date_later" id="mortgage_date_later">
                                            <option
                                                value=""
                                                style={{ color: "#FFF", backgroundColor: "blue" }}
                                            >
                ...
                <tr valign="top">
                    <td>
                        <fieldset>
                            ...
                            <small>Lower Range or Exact Values</small>
                            <br />
                            <select onChange={handleChange} name="HOME_MARKET_VALUE" id="HOME_MARKET_VALUE">
                ...
                <tr>
                    <td>
                        <fieldset>
                            ...
                            <input onChange={handleChange} type="radio" name="FUEL" id="FUEL_Gas" value="Gas" />
                            ...
                            <input onChange={handleChange} type="radio" name="FUEL" id="FUEL_Oil" value="Oil" />
                    ...
                    <td>
                        <fieldset>
                            ...
                            <input onChange={handleChange}
                                ...
                                value="AC DUAL UNIT"
                            />
                            <label htmlFor="AIR_CONDITIONING_AC DUAL UNIT">Ac Dual Unit</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="AIR_CONDITIONING"
                            ...
                            <input onChange={handleChange}
                                ...
                                value="AC HEAT PUMP"
                            />
                            <label htmlFor="AIR_CONDITIONING_AC HEAT PUMP">Ac Heat Pump</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="AIR_CONDITIONING"
                            ...
                            <input onChange={handleChange}
                                ...
                                value="AC WALL UNIT"
                            />
                            <label htmlFor="AIR_CONDITIONING_AC WALL UNIT">Ac Wall Unit</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="AIR_CONDITIONING"
                ...
                <tr>
                    <td>
                        <fieldset>
                            ...
                            <input onChange={handleChange} type="radio" name="WATER" id="WATER_Well" value="Well" />
                ...
                <tr>
                    <td>
                        <fieldset>
                            ...
                            <input onChange={handleChange} type="radio" name="GENDER" id="GENDER_F" value="F" />
                            <label htmlFor="GENDER_F">Female</label> |
                            <input onChange={handleChange} type="radio" name="GENDER" id="GENDER_M" value="M" />
                ...
                <tr>
                    <td>
                        <fieldset id="fsVISA">
                            ...
                            <input onChange={handleChange} type="radio" name="VISA" id="VISA_Y" value="Y" />{" "}
                            <label htmlFor="VISA_Y">Yes</label> |{" "}
                            <input onChange={handleChange} type="radio" name="VISA" id="VISA_N" value="N" />{" "}
                            ...
                            <input onChange={handleChange} type="radio" name="VISA_AND_OR" id="VISA_OR" value="1" />
                    ...
                    <td>
                        <fieldset id="fsGASOLINE_OR_RETAIL_CARD_REGULAR">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />{" "}
                            <label htmlFor="GASOLINE_OR_RETAIL_CARD_REGULAR_NULL">Either</label>
                            <hr />
                            <input onChange={handleChange}
                                type="radio"
                ...
                <tr>
                    <td>
                        <fieldset id="fsTENNIS">
                            ...
                            <input onChange={handleChange} type="radio" name="TENNIS" id="TENNIS_Y" value="Y" />{" "}
                            <label htmlFor="TENNIS_Y">Yes</label> |{" "}
                            <input onChange={handleChange} type="radio" name="TENNIS" id="TENNIS_N" value="N" />{" "}
                    ...
                    <td>
                        <fieldset id="fsGOLF">
                            <legend>Golf</legend>
                            <input onChange={handleChange} type="radio" name="GOLF" id="GOLF_Y" value="Y" />{" "}
                            <label htmlFor="GOLF_Y">Yes</label> |{" "}
                            <input onChange={handleChange} type="radio" name="GOLF" id="GOLF_N" value="N" />{" "}
                            ...
                            <input onChange={handleChange} type="radio" name="GOLF_AND_OR" id="GOLF_OR" value="1" />
                ...
                <tr>
                    <td>
                        <fieldset id="fsNASCAR">
                            ...
                            <input onChange={handleChange} type="radio" name="NASCAR" id="NASCAR_Y" value="Y" />{" "}
                            <label htmlFor="NASCAR_Y">Yes</label> |{" "}
                            <input onChange={handleChange} type="radio" name="NASCAR" id="NASCAR_N" value="N" />{" "}
                ...
                <tr>
                    <td>
                        <fieldset id="fsHUNTING">
                            ...
                            <input onChange={handleChange} type="radio" name="HUNTING" id="HUNTING_N" value="N" />{" "}
                    ...
                    <td>
                        <fieldset id="fsFISHING">
                            ...
                            <input onChange={handleChange} type="radio" name="FISHING" id="FISHING_N" value="N" />{" "}
                    ...
                    <td>
                        <fieldset id="fsEXERCISE_HEALTH_GROUPING">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="EXERCISE_HEALTH_GROUPING_AND">All Must Match</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="EXERCISE_HEALTH_GROUPING_AND_OR"
                                ...
                                value="1"
                            />
                            <label htmlFor="EXERCISE_HEALTH_GROUPING_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                    <td>
                        <fieldset id="fsAVIATION">
                            ...
                            <input onChange={handleChange} type="radio" name="AVIATION" id="AVIATION_N" value="N" />{" "}
                ...
                <tr>
                    <td>
                        <fieldset id="fsTRAVEL">
                            ...
                            <input onChange={handleChange} type="radio" name="TRAVEL" id="TRAVEL_Y" value="Y" />{" "}
                            <label htmlFor="TRAVEL_Y">Yes</label> |{" "}
                            <input onChange={handleChange} type="radio" name="TRAVEL" id="TRAVEL_N" value="N" />{" "}
                    ...
                    <td>
                        <fieldset id="fsTRAVEL_INTERNATIONAL">
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />
                            <label htmlFor="TRAVEL_INTERNATIONAL_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                    <td>
                        <fieldset id="fsTRAVEL_CRUISE_VACATIONS">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="TRAVEL_CRUISE_VACATIONS_AND">All Must Match</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="TRAVEL_CRUISE_VACATIONS_AND_OR"
                                ...
                                value="1"
                            />
                            <label htmlFor="TRAVEL_CRUISE_VACATIONS_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <fieldset id="fsSPECTATOR_SPORTS_TV_SPORTS">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="SPECTATOR_SPORTS_TV_SPORTS_AND">All Must Match</label>{" "}
                            |
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_TV_SPORTS_AND_OR"
                    ...
                    <td>
                        <fieldset id="fsSPECTATOR_SPORTS_AUTO_MOTORCYCLE_RACING">
                            ...
                            <input onChange={handleChange}
                                ...
                                value="Y"
                            />{" "}
                            <label htmlFor="SPECTATOR_SPORTS_AUTO_MOTORCYCLE_RACING_Y">Yes</label>{" "}
                            |{" "}
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_AUTO_MOTORCYCLE_RACING"
                                ...
                                value="N"
                            />{" "}
                            <label htmlFor="SPECTATOR_SPORTS_AUTO_MOTORCYCLE_RACING_N">No</label>{" "}
                            |
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_AUTO_MOTORCYCLE_RACING"
                    ...
                    <td>
                        <fieldset id="fsSPECTATOR_SPORTS_FOOTBALL">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="SPECTATOR_SPORTS_FOOTBALL_AND">All Must Match</label>{" "}
                            |
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_FOOTBALL_AND_OR"
                    ...
                    <td>
                        <fieldset id="fsSPECTATOR_SPORTS_BASEBALL">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="SPECTATOR_SPORTS_BASEBALL_AND">All Must Match</label>{" "}
                            |
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_BASEBALL_AND_OR"
                    ...
                    <td>
                        <fieldset id="fsSPECTATOR_SPORTS_HOCKEY">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="SPECTATOR_SPORTS_HOCKEY_AND">All Must Match</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_HOCKEY_AND_OR"
                                ...
                                value="1"
                            />
                            <label htmlFor="SPECTATOR_SPORTS_HOCKEY_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                </tr>
                <tr>
                    <td>
                        <fieldset id="fsSPECTATOR_SPORTS_SOCCER">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="SPECTATOR_SPORTS_SOCCER_AND">All Must Match</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="SPECTATOR_SPORTS_SOCCER_AND_OR"
                                ...
                                value="1"
                            />
                            <label htmlFor="SPECTATOR_SPORTS_SOCCER_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                    <td>
                        <fieldset id="fsSWEEPSTAKES_CONTESTS">
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />
                            <label htmlFor="SWEEPSTAKES_CONTESTS_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <fieldset id="fsCOLLECTIBLES_GENERAL">
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />
                            <label htmlFor="COLLECTIBLES_GENERAL_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                    <td>
                        <fieldset id="fsCOLLECTIBLES_STAMPS">
                            ...
                            <input onChange={handleChange}
                                ...
                                value="1"
                            />
                            <label htmlFor="COLLECTIBLES_STAMPS_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <fieldset id="fsCOLLECTIBLES_ANTIQUES">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="COLLECTIBLES_ANTIQUES_AND">All Must Match</label> |
                            <input onChange={handleChange}
                                type="radio"
                                name="COLLECTIBLES_ANTIQUES_AND_OR"
                                ...
                                value="1"
                            />
                            <label htmlFor="COLLECTIBLES_ANTIQUES_OR">Any Match On This</label>
                        </fieldset>
                    </td>
                    <td>
                        <fieldset id="fsMILITARY_MEMORABILIA_WEAPONRY">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />{" "}
                            <label htmlFor="MILITARY_MEMORABILIA_WEAPONRY_NULL">Either</label>
                            <hr />
                            <input onChange={handleChange}
                                type="radio"
                    ...
                    <td>
                        <fieldset id="fsCOLLECTIBLES_SPORTS_MEMORABILIA">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />{" "}
                            <label htmlFor="COLLECTIBLES_SPORTS_MEMORABILIA_NULL">Either</label>
                            <hr />
                            <input onChange={handleChange}
                                type="radio"
                    ...
                    <td>
                        <fieldset id="fsHOME_IMPROVEMENT_GROUPING">
                            ...
                            <input onChange={handleChange}
                                ...
                                defaultChecked
                            />
                            <label htmlFor="HOME_IMPROVEMENT_GROUPING_AND">All Must Match</label>{" "}
                            |
                            <input onChange={handleChange}
                                type="radio"
                                name="HOME_IMPROVEMENT_GROUPING_AND_OR"
                ...
                <tr>
                    <td>
                        <fieldset id="fsCRAFTS">
                            ...
                            <input onChange={handleChange} type="radio" name="CRAFTS" id="CRAFTS_Y" value="Y" />{" "}
                            <label htmlFor="CRAFTS_Y">Yes</label> |{" "}
                            <input onChange={handleChange} type="radio" name="CRAFTS" id="CRAFTS_N" value="N" />{" "}
